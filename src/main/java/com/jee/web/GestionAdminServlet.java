...
public class GestionAdminServlet extends HttpServlet {
   ...
   private  SQLDataSource ds;
	public void init() throws ServletException {
		...
		dao = new AdminManager(ds);
		business = new AdminBusiness(dao);
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(uri.contains("sign in")) {
            ...
            if(business.verify(login, password)) {
            	...
            	request.getRequestDispatcher("/html/authenAdminEror.html").forward(request, resp);
            }
		}
			...
			Admin a = new Admin(name,lastname,login, password);
			business.insert(a);
